...
class _MapScreenState extends State<MapScreen> {
  ...
  final List<LocationMarker> _sampleLocations = [
    LocationMarker(
        id: '1',
        title: 'Charminar',
        snippet: 'Iconic mosque with 4 minarets.',
        position: const LatLng(17.3616, 78.4747)),
    LocationMarker(
        id: '2',
        title: 'Golconda Fort',
        snippet: 'A citadel and fort from the Qutb Shahi dynasty.',
        position: const LatLng(17.3833, 78.4011)),
    LocationMarker(
        id: '3',
    ...
    LocationMarker(
        id: '4',
        title: 'HITEC City',
        snippet: 'Hyderabad\'s major IT and tech hub.',
